...
export default function FolderItem({ folder }: FolderItemProps) {
  return (
    <div className="relative w-full flex flex-col justify-center items-center h-[120px] rounded-lg p-5 bg-white/10 hover:scale-105 hover:shadow-md cursor-pointer">
