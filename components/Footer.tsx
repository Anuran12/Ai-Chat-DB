...
export default function Footer() {
  return (
    <div className="pb-5 pt-28 bg-gradient-to-b from-white/0 via-[#4A90A4]/10 to-[#4A90A4]/50 flex flex-col gap-8">
      <div className="px-[8vw] w-full flex justify-between items-center">
        <div className="flex flex-col w-[50%]">
          <Image src={Logo} alt="Logo" height={45} />
          <h1 className="inline-block w-[50%] font-semibold text-[1.3rem] bg-[radial-gradient(100%_100%_at_50%_50%,rgba(229,229,229,1)_30%,rgba(255,255,255,0.2)_85%)] text-transparent bg-clip-text text-left">
            Transform your data into an intelligent chatbot.
          </h1>
        </div>
        <div className="grid grid-cols-3 gap-[2vw] w-[50%] justify-end items-end">
      ...
      <div className="w-full bg-[#010314] flex justify-between px-[8vw] py-3 text-[#77798F] text-[0.8rem]">
